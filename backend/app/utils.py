"""
Utilidades para geolocalización y generación de enlaces de Maps.
"""
...
def is_within_penalty_window(departure_time: datetime, hours: int = 6) -> bool:
    ...
    Args:
        departure_time (datetime): Hora de salida del viaje.
        hours (int): Horas de la ventana de penalización. Default 6.
        
    Returns:
        bool: True si estamos en ventana de penalización (cerca del viaje), False si falta mucho.
    """
