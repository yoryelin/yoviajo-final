...
const Layout = ({ children }) => {
    ...
    return (
        <div className="min-h-screen bg-slate-950 font-sans text-slate-200 selection:bg-cyan-500 selection:text-white overflow-x-hidden flex flex-col">
            ...
            {/* FOOTER (Logged In) */}
            <footer className="border-t border-slate-800 py-4 text-center text-slate-500 text-xs mt-auto bg-slate-950/50">
                <div className="flex justify-center gap-6 mb-2 items-center">
                    ...
                    <a href="/seguridad" className="hover:text-cyan-400 transition font-bold">Seguridad</a>
